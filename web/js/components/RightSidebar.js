            ...
            <aside className={"d-inline-flex flex-wrap justify-content-center"}>
                ...
                <div className="d-inline-flex p-3 bg-light flex-wrap justify-content-center">
                    <div className="p-1 bg-light">
                        <button className={"btn"} id="table" onClick={this.switchClick}>Table
                        </button>
                    </div>
                    <div className="p-1 bg-light">
                        <button className={"btn"} id="zone" onClick={this.switchClick}>Zone
                        </button>
                    </div>
                    <div className="p-1 bg-light">
                        <button className={"btn"} id="section" onClick={this.switchClick}>Rangée
                        </button>
                    </div>
                </div>}
                {this.props.updateObject &&
                ...
                {!this.props.updateObject &&
                <SaveCanvas saveCanvas={this.saveCanvas} updateObject={this.props.updateObject}/>}

                <Fade in={this.state.clickedSection && !this.props.updateObject}
                      style={{transitionDelay: this.props.clickedSection ? '50ms' : '50ms'}}>{<div id="sectionCreate"
                                                                                                   style={{display: (this.state.clickedSection && !this.props.updateObject) ? "inherit" : "none"}}>
                ...
                <Fade in={this.state.clickedTable && !this.props.updateObject}
                      style={{transitionDelay: this.props.clickedTable ? '50ms' : '50ms'}}>{<div id="tableCreate"
                                                                                                 style={{display: (this.state.clickedTable && !this.props.updateObject) ? "inherit" : "none"}}>
                    <div className="d-flex p-3 bg-light">
                ...
                <Fade in={this.state.clickedZone && !this.props.updateObject}
                      style={{transitionDelay: this.props.clickedZone ? '50ms' : '50ms'}}>{<div id="zoneCreate"
                                                                                                style={{display: (this.state.clickedZone && !this.props.updateObject) ? "inherit" : "none"}}>
                    <div className="d-flex p-3 bg-light">
