...
class EventsChartBlockByPlaceService extends AbstractBlockService
{
    ...
    public function configureSettings(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            ...
            'repository_method' => 'getAllEventsByPlace',
            'title' => 'Evènements',
            'template' => 'AdminBundle:admin:chart_block_events_by_place.html.twig',
