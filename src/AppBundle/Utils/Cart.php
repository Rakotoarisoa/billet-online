...
class Cart implements \ArrayAccess
{
    ...
    public function getDiscountTotal()
    {
        ...
        if ($this->getCoupon() == null) {
            $discountPrice = $this->getDiscountPrice(0, 0, $this->discount);
            ...
            if (@min($this->getCategoriesByCount()) >= 0) {
                ...
                $discountTotal = $discountTotal - 0;// - ($discountTotal * (1/*$this->lineDiscount*/ / 100));
            }
        } else {
